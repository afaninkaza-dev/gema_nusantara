    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="history_container">
                ...
                <!-- Hari Ini -->
                <div>
                    <div class="section_label"><span>Hari Ini</span></div>
                    <div class="cerita_container">
                        ...
                        <div class="cerita_wrapper">
                            <img class="sampul" src="img/ceritabawang.svg" alt="Bawang Putih & Bawang Merah">
                            <h2>Bawang Putih & Bawang Merah</h2>
                            <hr>
                            <div class="rating">
                                <i class="fas fa-star star"></i>
                        ...
                        <div class="cerita_wrapper">
                            <img class="sampul" src="img/ceritabiwar.svg" alt="Biwar & Naga">
                            <h2>Biwar & Naga</h2>
                            <hr>
                            <div class="rating">
                                <i class="fas fa-star star"></i>
                ...
                <!-- Hari Sebelumnya -->
                <div>
                    <div class="section_label"><span>Selasa, 18/11/2025</span></div>
                    <div class="cerita_container">
